...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `calculate_days_trigger` BEFORE INSERT ON `booking` FOR EACH ROW SET NEW.days = DATEDIFF(NEW.checkout, NEW.checkin) */;;
DELIMITER ;
